...
class Trainer:
    ...
    def train(self, epochs=100):
        ...
        self.model.fit_generator(self.generate_arrays_from(), steps_per_epoch=int(self.X_train.shape[0] / self.training_batch_size), class_weight=self.class_weight, epochs=epochs, callbacks=[Validation(self.model, 5, self.num_classes, self.X_T, self.y_test), checkpoint])
